...
var refresh_objects_listeners = function () {
  ...
  $.each($(".carousel"), function (index, element) {
    // id="IdentifierCarousel"
    let car_id = "car-id-" + index;
    let template_ol = "<ol class='carousel-indicators'></ol>";
    let template_ol_compiled = $.parseHTML(template_ol);
    let template_li =
      "<li data-target='' data-slide-to='' data-ride='carousel'></li>";
    let text_items = $(this).find(".carousel-item");

    $(element).attr("id", car_id);
    $(element).prepend(template_ol_compiled);

    $.each(text_items, function (i, el) {
      let template_li_compiled_next = $.parseHTML(template_li);
      $(template_li_compiled_next).attr("data-target", "#" + car_id);
      $(template_li_compiled_next).attr("data-slide-to", i);
      $(template_li_compiled_next).attr("data-ride", "carousel");
      if (i == 0) {
        $(template_li_compiled_next).attr("class", "active");
        $(el).addClass("active");
      }

      $(template_ol_compiled).append(template_li_compiled_next);
    });
  ...
  $.each($(".close-tab-button"), function (index, element) {
    $(this).on("click", function () {
      window.location.href = "https://institutoembelleze.instructure.com/courses/49/assignments/347?module_item_id=959";
    });
  });
  ...
  $.each($(".lss_quiz_no_animation"), function (index, element) {
    ...
    //   success: function (data) {
        let database_json = {
          ...
          "gamemode": {
            "feedback_mode": true,
            "feedback_rule": "feed-and-go"
          },
          "questions": [
            {
              "Title": "Para um atendimento de excelência, é importante saber o que motiva o cliente a se interessar por um determinado serviço.<br/>De acordo com os conteúdos do curso, qual a alternativa indica os dois fatores que definem o comportamento de compra dos clientes?",
              "Answers": [
                {
                  "Title": "O preço cobrado pelo serviço e o local do atendimento.",
                  "Score": 0
                },
                {
                  "Title": "A recepção em sua chegada e o pós-atendimento.",
                  "Score": 0
                },
                {
                  "Title": "A anamnese capilar e o produto utilizado no cabelo.",
                  "Score": 0
                },
                {
                  "Title": "As necessidades e os desejos.",
                  "Score": 1
                }
              ],
              "Feedback-certo": "Parabéns! <br/> Você se dedicou e estudou o conteúdo com muita atenção. <br/> Sua resposta está correta!",
              "Feedback-chance": "Ainda não foi dessa vez, a resposta está errada. <br/> Mas não desista, você tem mais uma chance. <br/>Lembre-se de que os motivos podem ser apresentados sem que o cliente perceba, naturalmente, a partir do seu pedido.",
              "Feedback-errado": "Sua resposta está errada, que pena. <br/> A resposta correta é <b>as necessidades e os desejos</b>.<br/>As necessidades podem estar relacionadas a uma questão social; e o desejo, a uma vontade do cliente."
            },
            {
              "Title": "Para criar um relacionamento de confiança com o cliente, é importante saber o que cada um considera como “melhor” para si. Existem técnicas que ajudam a identificar esse comportamento, e uma delas é o <em>feedback</em>. Qual alternativa indica corretamente o que é o <em>feedback</em>?",
              "Answers": [
                {
                  "Title": "É ligar para o cliente no dia seguinte ao atendimento.",
                  "Score": 0
                },
                {
                  "Title": "É pedir para o cliente dar uma nota para o profissional.",
                  "Score": 0
                },
                {
                  "Title": "É a opinião do cliente sobre o serviço que ele recebeu.",
                  "Score": 1
                },
                {
                  "Title": "É quando o cliente compra os produtos que utilizou.",
                  "Score": 0
                }
              ],
              "Feedback-certo": "Parabéns! <br/> Você se dedicou e estudou o conteúdo com muita atenção. <br/> Sua resposta está correta!",
              "Feedback-chance": "Ainda não foi dessa vez, a resposta está errada. <br/> Mas não desista, você tem mais uma chance. <br/> Lembre-se de que ter o retorno do cliente ajuda você a melhorar os serviços oferecidos.",
              "Feedback-errado": "Sua resposta está errada, que pena. <br/> A resposta correta é <b>opinião do cliente sobre o serviço que ele recebeu</b>, ou seja, a confirmação de que você fez o que foi pedido."
            },
            {
              "Title": "Mostrar interesse e preocupação com o cliente é fundamental. Em nosso trabalho, podemos adotar algumas práticas que ajudem a atingir esse objetivo, de forma profissional e ética. A anamnese capilar é uma delas. Qual é a alternativa que indica o que é a anamnese capilar?",
              "Answers": [
                {
                  "Title": "Avaliar as condições do cabelo e do couro cabeludo antes de realizar o procedimento.",
                  "Score": 1
                },
                {
                  "Title": "Analisar se o serviço atingiu as expectativas do cliente.",
                  "Score": 0
                },
                {
                  "Title": "Oferecer um produto extra para o cliente comprar.",
                  "Score": 0
                },
                {
                  "Title": "Observar a satisfação do cliente com o cabelo.",
                  "Score": 0
                }
              ],
              "Feedback-certo": "Parabéns! <br/> Você se dedicou e estudou o conteúdo com muita atenção. <br/> Sua resposta está correta!",
              "Feedback-chance": "Ainda não foi dessa vez, a resposta está errada. <br/> Mas não desista, você tem mais uma chance.<br/>Lembre-se de que é importante analisar todas as características antes de qualquer serviço.",
              "Feedback-errado": "Sua resposta está errada, que pena. A resposta correta é <b>avaliar as condições do cabelo e do couro cabeludo antes de realizar o procedimento</b>. Assim, o profissional consegue saber se o cabelo permite receber determinado serviço ou produto."
            },
            {
              "Title": "O profissional da beleza que realiza um atendimento de excelência, certamente conquistará o cliente, pois suas atitudes são consideradas como um diferencial no mercado.<br/> Assinale a alternativa que indica os quatro momentos que fazem parte do atendimento de excelência em um serviço de beleza.",
              "Answers": [
                {
                  "Title": "Sorriso, simpatia com o cliente, oferecer café como cortesia e desconto no serviço.",
                  "Score": 0
                },
                {
                  "Title": "Telefone, recepção, profissionais e serviços.",
                  "Score": 1
                },
                {
                  "Title": "Preço acessível, realizar um serviço complementar, oferecer desconto e atender com atenção.",
                  "Score": 0
                },
                {
                  "Title": "Atendimento com atenção, oferecer café, vender produtos e indicar promoções de serviços.",
                  "Score": 0
                }
              ],
              "Feedback-certo": "Parabéns! <br/> Você se dedicou e estudou o conteúdo com muita atenção. <br/> Sua resposta está correta!",
              "Feedback-chance": "Ainda não foi dessa vez, a resposta está errada. <br/> Mas não desista, você tem mais uma chance. <br/> Lembre-se que esses fatores podem ser apresentados sem que o cliente perceba.",
              "Feedback-errado": "Sua resposta está errada, que pena.<br/>A resposta correta é <b>telefone, recepção, profissionais e serviços</b>.<br/>O telefone corresponde à ligação do cliente no momento de agendar o serviço; a recepção é como recebemos o cliente quando ele chega para iniciar os procedimentos; os profissionais correspondem à forma que se apresentam, de acordo com a sua higiene e asseio pessoal; e, por fim, a qualidade dos serviços realizados."
            }
          ]
        };
        let lss_settings = database_json["settings"];
